...
The following versions of sea-orm-cubrid are currently supported for security updates:
...
We take security vulnerabilities seriously. If you discover a security issue in sea-orm-cubrid, please report it responsibly by emailing:
...
- Affect the security posture of applications using sea-orm-cubrid

Examples include:
- SQL injection vulnerabilities in query construction
- Authentication/authorization flaws in the connection implementation
...
2. **Affected Versions:** Which version(s) of sea-orm-cubrid are vulnerable
...
When using sea-orm-cubrid, follow these security best practices:

- Always use parameterized queries to prevent SQL injection
- Keep sea-orm-cubrid updated to the latest version
...
We appreciate your responsible disclosure and help in keeping sea-orm-cubrid secure.
